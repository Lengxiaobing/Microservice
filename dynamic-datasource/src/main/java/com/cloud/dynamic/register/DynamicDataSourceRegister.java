package com.cloud.dynamic.register;

import com.cloud.dynamic.config.DynamicDataSourceContextHolder;
import com.cloud.dynamic.config.DynamicRoutingDataSource;
...
/**
 * @Description: 动态数据源注册
 * 实现 ImportBeanDefinitionRegistrar 用于数据源注册
...
public class DynamicDataSourceRegister implements ImportBeanDefinitionRegistrar, EnvironmentAware {
    ...
    public void registerBeanDefinitions(AnnotationMetadata annotationMetadata, BeanDefinitionRegistry beanDefinitionRegistry) {
        ...
        log.info("注册数据源成功，一共注册{}个数据源", customDataSources.size() + 1);
    }
