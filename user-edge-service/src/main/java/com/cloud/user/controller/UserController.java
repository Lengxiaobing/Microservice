...
import com.cloud.user.redis.RedisClient;
import com.cloud.thrift.user.UserInfo;
import com.cloud.thrift.user.dto.UserDTO;
import com.cloud.user.response.LoginResponse;
import com.cloud.user.response.Response;
import com.cloud.user.thrift.ServiceProvider;
